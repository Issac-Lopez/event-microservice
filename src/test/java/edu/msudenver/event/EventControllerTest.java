...
public class EventControllerTest {
    ...
    public void testGetEvent() throws Exception {
        ...
        Event testEvent = new Event();
        testEvent.setTitle("Fight Club");
        Mockito.when(this.eventRepository.findById(Mockito.anyLong())).thenReturn(Optional.of(testEvent));
        MvcResult result = this.mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse response = result.getResponse();
        Assertions.assertEquals(HttpStatus.OK.value(), response.getStatus());
        Assertions.assertTrue(response.getContentAsString().contains("Fight Club"));
    ...
    public void testGetEventNotFound() throws Exception {
        ...
        Mockito.when(this.eventRepository.findById(Mockito.anyLong())).thenReturn(Optional.empty());
