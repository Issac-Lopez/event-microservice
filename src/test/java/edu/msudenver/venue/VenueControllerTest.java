...
public class VenueControllerTest {
    ...
    public void testGetVenue() throws Exception {
        ...
        Mockito.when(this.venueRepository.findById(Mockito.anyLong())).thenReturn(Optional.of(testVenue));
    ...
    public void testGetVenueNotFound() throws Exception {
        ...
        Mockito.when(this.venueRepository.findById(Mockito.anyLong())).thenReturn(Optional.empty());
