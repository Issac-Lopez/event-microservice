...
public class CountryControllerTest {
    ...
    public void testCreateCountry() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .post("/countries/")
                .accept(MediaType.APPLICATION_JSON)
                .content("{\"countryCode\":\"ar\", \"countryName\": \"Argentina\"}")
                .contentType(MediaType.APPLICATION_JSON);
        Country canada = new Country();
        canada.setCountryName("Argentina");
        canada.setCountryCode("ar");
        ...
        assertTrue(response.getContentAsString().contains("Argentina"));
    }
    @Test
    ...
    public void testUpdateCountry() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .put("/countries/ar")
                .accept(MediaType.APPLICATION_JSON)
                .content("{\"countryCode\":\"ar\", \"countryName\": \"Argentina Updated\"}")
                .contentType(MediaType.APPLICATION_JSON);
        Country canada = new Country();
        canada.setCountryName("Argentina");
        canada.setCountryCode("ar");
        ...
        canadaUpdated.setCountryName("Argentina Updated");
        canadaUpdated.setCountryCode("ar");
        ...
        MockHttpServletResponse response = result.getResponse();
        assertEquals(HttpStatus.OK.value(), response.getStatus());
        assertTrue(response.getContentAsString().contains("Argentina Updated"));
    }
    @Test
